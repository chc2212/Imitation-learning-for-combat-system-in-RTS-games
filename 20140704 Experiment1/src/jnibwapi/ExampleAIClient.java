...
public class ExampleAIClient implements BWAPIEventListener {
	...
	public void matchStart() {
		...
		if(gameNumber % 20 == 0 && gameNumber != 0)
		{
			if(gameNumber == 100)
				PreProcess.LIMITLINE = 100; // 게임 씬 장면 자동화.
			/*if(gameNumber == 200)
				PreProcess.randomNumber = 8265;		
			if(gameNumber == 300)
				PreProcess.randomNumber = 5069;
			if(gameNumber == 400)
				PreProcess.randomNumber = 3379;
			if(gameNumber == 500)
				PreProcess.randomNumber = 1688;*/
			/*if(gameNumber == 40)
